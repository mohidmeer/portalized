    ...
    return (
        <section className='p-4'>
            ...
            <div className='max-w-7xl mx-auto bg-dotmap h-[60vh]  bg-cover  bg-center flex flex-col justify-center items-center relative '>
                <div className='h-[250px] w-[250px]  sm:h-[500px] sm:w-[500px]  border-4 rounded-full justify-center items-center flex  '>
                    <div className='w-20 h-20 sm:w-full sm:h-full justify-center items-center flex ' >
                        <TestimonialItem
